...
<body>
	...
	<?php
		$decription = $title = $upload = $dayUp = '';
		$errDec = $errTitle = $errUp = $errDayUp = '';
		$check = true;
		...
		if(isset($_POST['upload'])){
			...
			if($check){
				$sqlInsert = "INSERT INTO news(TITLE, DECRIPTION, dayUp, Image) VALUES ('$title', '$decription', '$dayUp', '$file')";
	...
	<h1>Upload product</h1>
		...
		<p>
			...
			<input type="date" name="day"><?php echo $dayUp; ?>
		...
		<p>
			<a href='php/show.php'><input type="button" class="upload"  value="List"></a>
		</p>
	</form>
</body>
</html>